export default (function() {
  ...
  PetalFloat.prototype.init = function() {
    if (this.box) {
      return
    }
  ...
  PetalFloat.prototype.reSize = function() {
  ...
  PetalFloat.prototype.action = function() {
  ...
  PetalFloat.prototype.render = function(k) {
    this.action()
  ...
  PetalFloat.prototype.addImg = function() {
    let py = 0; let px = 0
    if (Math.random() >= 0.5) {
  ...
  PetalFloat.prototype.start = function() {
    for (var i = 0; i < 4; i++) {
      this.addImg()
    }
  ...
  PetalFloat.prototype.stop = function() {
    cancelAnimationFrame(this._anmition)
  }

  PetalFloat.prototype.drawImg = function(param) {
